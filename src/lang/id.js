...
export default {
  ...
  label: {
    ...
    transmission_pattern: 'Pola Transmisi',
    type_transmission: 'Jenis Transmisi',
    cluster_type: 'Jenis Klaster',
    please_specify_other_types_if_any: 'Sebutkan Jenis lainnya (jika ada)',
    ...
    pcr: 'PCR',
    ct_scan: 'CT-Scan',
    tcm_sars_cov_2: 'TCM-SARS COV-2',
    add_contact_data: 'Tambah Data Kontak',
    whether_hospitalized: 'Apakah dirawat di rumah sakit ?',
    hand_prix: 'Hand Prix',
    flebotomy: 'Flebotomy',
    ...
    export: 'Ekspor',
    export_xls: 'Unduh .XLS',
    export_png: 'Unduh .PNG',
    export_excel: 'Unduh Excel',
    export_recap: 'Unduh Rekap',
    export_data: 'Ekspor Data',
    export_patient_data: 'Ekspor Data Pasien',
    export_clinical_history: 'Ekspor Riwayat Klinis',
    from_abroad_or_out_town: 'Dari Luar Negeri/Luar Kota',
    to_local_transmission: 'Ke Transmisi Lokal',
    local_transmission: 'Transmisi Lokal',
    to_public_place: 'Ke Tempat Publik',
    public_place: 'Tempat Publik',
    minutes: 'Menit',
    hours: 'Jam',
    ...
    total_2: 'Total',
    unit: 'Satuan',
    country_or_province: 'Negara/Provinsi',
    ...
    input_history: 'Input Riwayat',
    edit_history: 'Ubah Riwayat',
    ...
    add_supporting_investigation: 'Tambah Pemeriksaan Penunjang/Hasil Test',
    ...
    view_local_transmission_area_history: 'Lihat Riwayat Area Transmisi Lokal',
    local_transmission_area_history_list: 'List Riwayat Area Transmisi Lokal',
    serum: 'Serum',
    komorbid: 'Komorbid',
    ...
    add_inspection_support: 'Tambah Pemeriksaan Penunjang',
    edit_inspection_support: 'Edit Pemeriksaan Penunjang',
    input_inspection_support: 'Input Pemeriksaan Penunjang',
    view_public_place_history: 'Lihat Riwayat Tempat Publik',
    list_public_place_history: 'List Riwayat Tempat Publik',
    ...
    swab_nasofaring: 'Swab Nasofaring',
    swab_orofaring: 'Swab Orofaring',
    swab_naso_orofaring: 'Swab Naso-Orofaring',
    ...
    usage_guide_import_2: 'a. Unduh template excel yang telah disediakan',
    usage_guide_import_3: 'b. Isi dan lengkapi data kasus pada template excel',
    usage_guide_import_4: 'c. Setelah selesai melengkapi data, tekan simpan pada excel',
    usage_guide_import_5: '2. Masukkan file excel yang akan diimport dengan klik pada bagian “Tambah file”. Kemudian klik “Import”',
    ...
    terms_and_conditions_import_2: '2. Bagi pasien berkriteria konfirmasi, wajib mengisi “Pola Transmisi”',
    terms_and_conditions_import_3: '3. Jumlah maksimum data dalam sekali import adalah 200 baris',
    terms_and_conditions_import_4: '4. Import hanya dapat digunakan untuk data kasus baru yang belum pernah diinput pada Aplikasi Pelaporan',
    terms_and_conditions_import_5: '5. Data yang sudah pernah diinput sebaiknya diperbarui/update secara manual untuk menghindari duplikasi data',
    terms_and_conditions_import_6: '6. Waktu penggunaan import yang disarankan pada pukul 07:00-08:00 dan 15:00 -19:00',
    terms_and_conditions_import_7: '7. Import hanya dapat dilakukan oleh Dinas Kesehatan Kabupaten/Kota',
    ...
    medical_personnel_data_patient_identity_patient_criteria: 'Data petugas medis, identitas pasien & kriteria pasien',
    case_history_data_and_patient_clinical_info: 'Data riwayat kasus dan info klinis pasien',
    supporting_information_data_and_patient_test_results: 'Data pemeriksaan penunjang dan hasil test pasien',
  ...
  success: {
    ...
    send_data_success: 'Data Berhasil Dikirim',
